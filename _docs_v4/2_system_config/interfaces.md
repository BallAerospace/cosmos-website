...
Cosmos provides the following interfaces for use: TCPIP Client, TCPIP Server, UDP, Serial, Command Telemetry Server, and LINC. The interface to use is defined by the [INTERFACE]({{site.baseurl}}/docs/v4/system#interface) and [ROUTER]({{site.baseurl}}/docs/v4/system#router) keywords.
...
See [INTERFACE]({{site.baseurl}}/docs/v4/system#interface) for a description of the INTERFACE keyword. See [Interface Modifiers]({{site.baseurl}}/docs/v4/system#interface-modifiers) for a description of the keywords which can follow the INTERFACE keyword.
...
See [INTERFACE]({{site.baseurl}}/docs/v4/system#interface) for a description of the INTERFACE keyword. See [Interface Modifiers]({{site.baseurl}}/docs/v4/system#interface-modifiers) for a description of the keywords which can follow the INTERFACE keyword. Note, TcpipServerInterface processes the [OPTION]({{site.baseurl}}/docs/v4/system#option) modifier.
...
See [INTERFACE]({{site.baseurl}}/docs/v4/system#interface) for a description of the INTERFACE keyword. See [Interface Modifiers]({{site.baseurl}}/docs/v4/system#interface-modifiers) for a description of the keywords which can follow the INTERFACE keyword. Note, SerialInterface processes the [OPTION]({{site.baseurl}}/docs/v4/system#option) modifier.
...
| Name                                                       | Description                                                                           |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [Burst]({{site.baseurl}}/docs/v4/protocols#burst-protocol)                 | Reads as much data as possible from the interface                                     |
| [Fixed]({{site.baseurl}}/docs/v4/protocols#fixed-protocol)                 | Processes fixed length packets with a known ID position                               |
| [Length]({{site.baseurl}}/docs/v4/protocols#length-protocol)               | Processes a length field at a fixed location and then reads the remainder of the data |
| [Terminated]({{site.baseurl}}/docs/v4/protocols#terminated-protocol)       | Delineates packets uses termination characters at the end of each packet              |
| [Template]({{site.baseurl}}/docs/v4/protocols#template-protocol)           | Processes text based command / response data such as SCPI interfaces                  |
| [Preidentified]({{site.baseurl}}/docs/v4/protocols#preidentified-protocol) | Internal COSMOS protocol used by COSMOS tools                                         |
...
| Name                                             | Description                                                         |
| ------------------------------------------------ | ------------------------------------------------------------------- |
| [Override]({{site.baseurl}}/docs/v4/protocols#override-protocol) | Allows telemetry items to be fixed to given value when read         |
| [CRC]({{site.baseurl}}/docs/v4/protocols#crc-protocol)           | Adds CRCs to outgoing packets and verifies CRCs on incoming packets |
| [Ignore]({{site.baseurl}}/docs/v4/protocols#ignore-protocol)     | Ignores the specified packet by dropping it                         |
...
In addition, you can define your own protocols which are declared like the COSMOS helper protocols after your interface. See the <a href="{{site.baseurl}}/docs/v4/protocols#custom-protocols">Custom Protocols</a> documentation for more information.
